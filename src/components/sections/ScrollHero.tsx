...
export default function ScrollHero({ isActive = true, onStageChange, resetTick }: ScrollHeroProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute z-20 hidden md:flex flex-col gap-10 md:gap-[3vh] px-5 md:pl-[11.1111vw] pt-10 md:pt-[5vh] pb-16 md:pb-[10vh] max-xl:md:pb-[3vh] max-xl:md:gap-[1.5vh]"
        style={{
